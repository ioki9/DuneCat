...
{
    m_window_width = m_settings.value(QStringLiteral("MainWindow/width"),1024).toInt();
    m_window_height = m_settings.value(QStringLiteral("MainWindow/height"),768).toInt();
...
{
    return m_window_maximized.load();
}
